<template>
    ...
    <img :src="isDark ? '/images/Background/QR_Code_Dark.png' :'/images/Background/QR_Code.png'" alt="" style="max-width: 550px;" class="w-full h-full object-cover opacity-90 absolute bottom-0 z-0">
